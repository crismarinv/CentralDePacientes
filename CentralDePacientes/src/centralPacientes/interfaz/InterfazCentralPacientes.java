...
public class InterfazCentralPacientes extends JFrame {
     ...
     * 
     * @param formaAdicion El punto en el que va ser adicionado el paciente (de
     *                     primero, último, antes de otro paciente o después de
     *                     otro paciente). formaAdicion pertenece a {ANTES,
     *                     DESPUES, COMIENZO, FINAL}
     * @param codigo       El código del paciente con relación al cual se va a
     *                     realizar la adición. Su valor sólo es considerado si
     *                     formaAdicion es ANTES o DESPUES
     */
    ...
    /**
     * Si la lista de pacientes no está vacía muestra el diálogo para que el
     * usuario seleccione la forma en la que desea realizar la adición del
     * paciente. Si la lista de pacientes está vacía se muestra el diálogo para
     * crear un paciente.
     */
     ...
     */
    public void agregarPaciente(int formaAdicion, int codPaciente, int elCodigo, String elNombre, String laClinica,
            String laHistoriaClinica, int elSexo) throws NoExisteException, YaExisteException {
    ...
    /**
     * Pide el código del paciente que se desea buscar, si lo encuentra muestra su
     * información en un diálogo. Si no se encuentra el paciente se muestra un
     * mensaje indicándolo.
     */
    public void buscarPaciente() {
        String codigo = JOptionPane.showInputDialog(this, "Código:", "Búsqueda Pacientes",
        ...
        try {
            if (codigo != null) {
                ...
                if (paciente != null) {
                    ...
                    JOptionPane.showMessageDialog(this, "El paciente con código " + cod + " no se encuentra registrado",
                            "Búsqueda de Pacientes", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "El código del paciente debe ser un valor numérico",
                    "Búsqueda de Pacientes", JOptionPane.ERROR_MESSAGE);
        }
    }

    /**
     * Pide el código del paciente que se desea eliminar, si lo elimina lo indica.
     * Si no se elimina el paciente se muestra un mensaje indicándolo.
     */
    public void eliminarPaciente() {
        String codigo = JOptionPane.showInputDialog(this, "Código:", "Eliminación Pacientes",
                JOptionPane.QUESTION_MESSAGE);
        try {
            if (codigo != null) {
                int cod = Integer.parseInt(codigo);
                ...
                JOptionPane.showMessageDialog(this, "El paciente fue eliminado", "Eliminación Pacientes",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "El código del paciente debe ser un valor numérico",
                    "Eliminación Pacientes", JOptionPane.ERROR_MESSAGE);
     ...
     * 
     * @param paciente El paciente al que se le va a mostrar la información.
     *                 paciente!=null.
     */
    ...
    public void reqFuncOpcion1() {
        ...
        JOptionPane.showMessageDialog(this, "La cantidad de hombres en la lista es: " + resultado, "Respuesta",
        		JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOpcion2() {
        ...
        JOptionPane.showMessageDialog(this, "La cantidad de mujeres en la lista es: " + resultado, "Respuesta",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOpcion4() {
        ...
        JOptionPane.showMessageDialog(this, "La clínica más ocupada es: " + resultado, "Respuesta",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void reqFuncOpcion5() {
        // Aquí puedes implementar cualquier funcionalidad adicional que requiera la
        // extensión 5.
        JOptionPane.showMessageDialog(this, "Funcionalidad de la extensión 5", "Respuesta",
                JOptionPane.INFORMATION_MESSAGE);
    }
