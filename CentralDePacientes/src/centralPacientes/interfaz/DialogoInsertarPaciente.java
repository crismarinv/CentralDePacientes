...
public class DialogoInsertarPaciente extends JDialog implements ActionListener {
     ...
     * @param tAdicion Tipo de adición que se va a realizar. tAdicion pertenece a
     *                 {ANTES, DESPUES, COMIENZO, FINAL}
     * @param elCodigo El código del paciente con relación al cual se va a realizar
     *                 la adición.
     */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (comando.equals(AGREGAR)) {
            try {
                ...
                if (elCodigo < 0) {
                    JOptionPane.showMessageDialog(this, "El código debe ser un número positivo", "Adición de Pacientes",
                            JOptionPane.ERROR_MESSAGE);
                } else if (elNombre == null || elNombre.equals("")) {
                    JOptionPane.showMessageDialog(this, "Debe ingresar el nombre del paciente", "Adición de Pacientes",
                            JOptionPane.ERROR_MESSAGE);
                } else if (laClinica == null || laClinica.equals("")) {
                    JOptionPane.showMessageDialog(this, "Debe ingresar la clínica del paciente", "Adición de Pacientes",
                            JOptionPane.ERROR_MESSAGE);
                } else if (laHistoria == null || laHistoria.equals("")) {
                    JOptionPane.showMessageDialog(this, "Debe ingresar la historia clínica del paciente",
                            "Adición de Pacientes", JOptionPane.ERROR_MESSAGE);
                } else {
                ...
                JOptionPane.showMessageDialog(this, "El código debe ser un valor numérico", "Adición de Pacientes",
                        JOptionPane.ERROR_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this,
                        "El paciente con código " + codigo
                                + " con relación al cual se va a realizar la adición no se encuentra registrado",
                        "Adición de Pacientes", JOptionPane.ERROR_MESSAGE);
            }
